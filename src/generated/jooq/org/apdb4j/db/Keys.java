...
public class Keys {
    ...
    public static final UniqueKey<Record> KEY_DAILY_RECAPS_PRIMARY = Internal.createUniqueKey(DailyRecaps.DAILY_RECAPS, DSL.name("KEY_daily_recaps_PRIMARY"), new TableField[] { DailyRecaps.DAILY_RECAPS.DATE }, true);
    ...
    public static final UniqueKey<Record> KEY_TICKET_TYPES_PRIMARY = Internal.createUniqueKey(TicketTypes.TICKET_TYPES, DSL.name("KEY_ticket_types_PRIMARY"), new TableField[] { TicketTypes.TICKET_TYPES.YEAR, TicketTypes.TICKET_TYPES.TYPE, TicketTypes.TICKET_TYPES.TARGET }, true);
