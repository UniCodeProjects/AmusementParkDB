...
public class Keys {
    ...
    public static final UniqueKey<Record> KEY_CONTRACTS_EMPLOYEENID = Internal.createUniqueKey(Contracts.CONTRACTS, DSL.name("KEY_contracts_EmployeeNID"), new TableField[] { Contracts.CONTRACTS.EMPLOYEENID, Contracts.CONTRACTS.SUBSCRIPTIONDATE }, true);
    ...
    public static final UniqueKey<Record> KEY_REVIEWS_IDREVIEW = Internal.createUniqueKey(Reviews.REVIEWS, DSL.name("KEY_reviews_IDREVIEW"), new TableField[] { Reviews.REVIEWS.FACILITYID, Reviews.REVIEWS.ACCOUNT }, true);
