...
public class Keys {
    ...
    public static final ForeignKey<Record, Record> FKPUBLICATION = Internal.createForeignKey(Reviews.REVIEWS, DSL.name("FKpublication"), new TableField[] { Reviews.REVIEWS.AUTHOR }, Keys.KEY_GUESTS_PRIMARY, new TableField[] { Guests.GUESTS.GUESTID }, true);
